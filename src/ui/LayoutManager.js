...
/**
 * The single owner of puzzle geometry. Theme and renderer must not define
 * game-table, containers-zone, shelf-container, shelf-items or book layout.
 */
  ...
  buildCSS() {
    return `
      ...
      #app .game-table .containers-zone {
        position: absolute;
        inset: 50% var(--game-padding) auto;
        width: auto;
      ...
      @media (max-width: 850px) {
        #app .game-table {
          ...
          height: min(var(--game-height), calc(100vh - 24px));
        }
        #app .game-table .containers-zone {
          left: 14px;
          right: 14px;
