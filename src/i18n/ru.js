export default {
  page: { title: 'Библиотека: Книжный порядок', description: 'Библиотека: Книжный порядок — увлекательная игра-сортировка книг по полкам', loading: 'Библиотека: Книжный порядок', loadingStatus: 'Загрузка…', error: 'Не удалось загрузить игру' },
  ...
  hud: { level: 'УРОВЕНЬ', difficulty: 'СЛОЖНОСТЬ', moves: 'ХОДЫ', score: 'ОЧКИ', time: 'ВРЕМЯ', undo: 'Назад', menu: 'Меню', topBook: 'Берём только верхнюю книгу', move: 'ХОД', library: 'Полки библиотеки' },
  theme: { displayName: 'Библиотека: Книжный порядок', description: 'Разложи книги по полкам', sortingRule: 'БИБЛИОТЕКА: КНИЖНЫЙ ПОРЯДОК • ПРАВИЛО СОРТИРОВКИ', bookSpine: 'КНИГА', bookLabel: 'Книга: {color}, {size}' },
  books: {
