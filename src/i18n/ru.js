export default {
  ...
  hud: { level: 'УРОВЕНЬ', difficulty: 'СЛОЖНОСТЬ', moves: 'ХОДЫ', score: 'ОЧКИ', time: 'ВРЕМЯ', undo: 'Назад', menu: 'Меню', topBook: 'Берём только верхнюю книгу', move: 'ХОД', library: 'Библиотека' },
