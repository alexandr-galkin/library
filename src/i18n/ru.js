export default {
  ...
  complete: { kicker: 'БИБЛИОТЕКА • УРОВЕНЬ ПРОЙДЕН', title: 'КНИГИ РАЗЛОЖЕНЫ', levelComplete: 'Уровень {level} пройден', stars: 'Три звезды', baseScore: 'Базовые очки', timeBonus: 'Бонус времени', total: 'ИТОГО', next: 'СЛЕДУЮЩИЙ УРОВЕНЬ' },
};
