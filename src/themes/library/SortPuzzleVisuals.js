const STYLE_ID = 'library-sort-puzzle-visuals-v5';
...
export function installSortPuzzleVisuals(documentRef = document) {
  ...
  style.id = STYLE_ID;
  style.textContent = `
    /* Field: fixed desktop size. Shelves are positioned INSIDE it. */
    .game-table {
    ...
    /* One row only. No second row, ever. */
    ...
    .game-table .shelf-container,
    .game-table .shelf-container.empty-shelf {
      position: relative !important;
    ...
    .shelf-count { color:#c3aa7c !important;font-size:.76rem !important;letter-spacing:1px !important }

    /* Keep the current GOOD book size. Do not impose 72x35 or any other fixed size. */
    .shelf-items {
      position:relative !important;
      z-index:2 !important;
      width:100% !important;
    ...
    @media(max-width:850px) {
      ...
      .game-table .containers-zone { left:14px !important;right:14px !important;gap:8px !important }
    }
    ...
    @media(max-width:700px) {
      ...
      .game-table .shelf-container,
      .game-table .shelf-container.empty-shelf { height:190px !important;min-height:190px !important }
