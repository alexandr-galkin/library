const STYLE_ID = 'library-sort-puzzle-visuals-v2';
...
export function installSortPuzzleVisuals(documentRef = document) {
  ...
  style.textContent = `
    /*
     * Puzzle layout is authoritative here.
     * Do not duplicate .containers-zone positioning in LibraryVisuals/main.css.
     */
    .containers-zone {
      ...
      width:min(770px,97vw)!important;
    ...
    /* With <=5 shelves the second grid row stays empty automatically. */
    .shelf-container,
    ...
    .shelf-container.highlight {
      ...
      border-color:#8e9b68!important;
      box-shadow:0 0 0 2px rgba(142,155,104,.15),0 0 25px rgba(142,155,104,.18)!important;
    }

    .shelf-container.reject {
      border-color:#a85c51!important;
      box-shadow:0 0 0 2px rgba(168,92,81,.14),0 0 22px rgba(168,92,81,.2)!important;
    }
    ...
    .shelf-items .book-item svg {
      ...
      filter:drop-shadow(2px 3px 2px rgba(0,0,0,.55))!important;
    }

    .shelf-items .book-item:not(:last-child) { opacity:.96!important; }
    .shelf-items .book-item:last-child { cursor:grab!important; }
    .shelf-items .book-item:last-child:hover { transform:translateY(-7px) rotate(-1deg)!important; }

    .shelf-items .book-item.dragging {
    ...
    .shelf-container.empty-shelf .shelf-items::after {
      content:'ПЕРЕНЕСИ КНИГУ СЮДА'!important;
      color:rgba(202,178,132,.26)!important;
      font:italic .72rem Georgia,serif!important;
      letter-spacing:1px!important;
      text-align:center!important;
    }

    .rule-banner { z-index:20!important; }
    ...
    @media(max-width:1100px) {
      ...
      .shelf-items { min-height:195px!important; height:195px!important; }
    }
    ...
    @media(max-width:700px) {
      ...
      .shelf-count { font-size:.55rem!important; }
